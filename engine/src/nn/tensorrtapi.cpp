...
#if !defined(MODE_POMMERMAN) && !defined(MODE_XIANGQI) && !defined(MODE_STRATEGO) && !defined(MODE_ATARI)
...
#endif
#if !defined(MODE_POMMERMAN) && !defined(MODE_OPEN_SPIEL) && !defined(MODE_XIANGQI) && !defined(MODE_STRATEGO) && !defined(MODE_ATARI)
